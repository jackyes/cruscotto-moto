...
- **HUD in fullscreen** (in basso a sinistra, lontano dai pulsanti di zoom): a mappa intera il cruscotto sparisce, quindi i numeri che servono in marcia vengono ripetuti sopra la mappa — piega attuale con il verso (◀ sinistra / destra ▶), i massimi di piega della sessione e la velocità in km/h. Fuori dal fullscreen non c'è e non viene aggiornato. Senza calibrazione la piega resta `--`, non uno zero finto.

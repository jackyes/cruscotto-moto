...
- **HUD in fullscreen** (in basso a sinistra, lontano dai pulsanti di zoom; in orizzontale a destra della colonna dei pulsanti): a mappa intera il cruscotto sparisce, quindi quello che serve in marcia viene ripetuto sopra la mappa con lo stesso linguaggio del gauge — arco da -60° a +60° riempito dal centro verso il lato della piega (verde a sinistra, ciano a destra) con la fascia rossa 50-60°, frecce del verso, pallini e valori dei massimi di piega della sessione, piega attuale colorata come sul cruscotto e velocità in km/h con il cartello del limite quando è noto e i km percorsi nella sessione. Oltre il limite (+3 km/h, come il badge del cruscotto) il cartello si riempie di rosso e la velocità diventa una pastiglia rossa; con affidabilità della piega bassa arco e numero si attenuano. Fuori dal fullscreen non c'è e non viene aggiornato. Senza calibrazione la piega resta `--`, non uno zero finto. Segue il tema: nel tema chiaro HUD, pulsanti della mappa e banner di manovra sono chiari, leggibili al sole.

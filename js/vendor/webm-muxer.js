"use strict";
// webm-muxer 5.1.4 (Vanilagy, MIT) - https://github.com/Vanilagy/webm-muxer
// Build IIFE (var WebMMuxer = (() => {...})()): tutto scoped dentro la
// closure, niente collisione di simboli globali con js/vendor/mp4-muxer.js
// (che è un bundle "flat", non-IIFE, e dichiara anche lui var Target/
// __privateGet/ecc. a livello globale: due bundle flat nello stesso scope
// si sovrascrivono a vicenda i simboli interni con lo stesso nome — bug
// reale osservato: "Encoder MP4 non configurabile: The target must be
// provided and an instance of Target." dopo aver caricato anche il muxer
// WebM flat).
var WebMMuxer = (() => {

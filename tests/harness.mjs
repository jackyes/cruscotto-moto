...
;globalThis.__api = {
  ...
  ATT_KP, ATT_KI, ATT_BIAS_MAX_DPS, ATT_TOL_G, ATT_MIN_REF_MAG_G, ATT_GPS_SIGN_MIN_G, ATT_NORM_TTL_MS, CENTRIP_MIN_MS, NORM_MODE_TRUST,
  LEAN_SMOOTH_TAU_S, LEAN_GYRO_MAX_DPS, ACC_MEDIAN_S, ACC_LP_TAU_S, VIB_TAU_S, LEAN_VIB_MAX,
  GPS_LAG_S, SPEED_HIST_S, SPEED_STALE_MS, SPEED_MAX_DEV_MS,
  GSIGN_TAU_S, GSIGN_MIN_ENERGY, DESPIKE_G, DESPIKE_RATIO, ACCEL_LIMIT_G, ACC_BIAS_MAX_G, ACC_BIAS_S, FUS_TAU_S,
  VIB_ADAPT_MAX, VIB_ADAPT_K, GYRO_LP_TAU_S, YAW_LP_TAU_S, ACC_FUS_RES_TAU_S,
  VIB_ADAPT_LP_TAU_S, YAW_LP_BASE_S, YAW_NOISE_MAX_DPS,
  GRAV_AGREE_DEG, GRAV_AGREE_G, RECT_TAU_S, RECT_LEAN_MAX_DEG, RECT_LON_MAX_G, RECT_VIB_MIN_G,
  RECT_VERT_MAX_G, RECT_NULL_MAX_G,
  ...
  MOUNT, CAM_DIST_CHOICES, CAM_DIST_DEFAULT, camDistFrom, choiceOr, COMPASS_OFFSETS,
  CSV_HEADER, NAV_BANDS, NAV_ICON, OSRM_MOD_IT, OSRM_ORD_IT,
  ...
  leanFromUp, pitchFromUp, buildBasis, calibBasis, calibOk, finiteVec, numOr0, mountKey, mountDef,
  despike, clampG, clamp01, medianWindow, pushAccHist, medianAcc, updateVibration, keepPeak, resetLogAcc,
  vibScale, biquadStep, biquadInit, updateRectDetector,
  pushSpeedHist, aIntAt, propagateSpeed, correctSpeed, updateGpsAccel, updateAccelFusion,
  attitudeReference, updateAttitude, updateGyroSign, resetGyroSignLearner, resetSensorFilters, processSample,
  ...
  rotContainerPoint, rotClientPoint, applyMapRotation, showSessionDetail,
  csvMeta, num, csvRows, buildCsv, buildGpx, stamp, fmtDur, takeLogAvg, snapshot, findRowAt, parseGpx,
  pushBounded, diagVerdict, diagTicks, diagChartScale, drawCharts, camPrecompute, routeCacheKey, geoCacheKey, cacheGetFresh, cachePut,
  ...
  sessionTotals, sessKey, planRestore, parseBackup, parseBackupFile, sanitizeCameras, buildBackupParts,
